...
public class TripPackage implements Serializable {
	...
	private List<com.gillsoft.client.model.info.route.Route> routeList;
	...
	public List<com.gillsoft.client.model.info.route.Route> getRouteList() {
		return routeList;
	}

	public void setRouteList(List<com.gillsoft.client.model.info.route.Route> routeList) {
